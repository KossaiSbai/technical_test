...
switch(arguments.length) {
  case 2:
    var taxis =  await allSuppliersTaxis(arguments[0],arguments[1]);
    console.log(taxis);
    break;
  case 3:
    if(suppliers.includes(arguments[2]))
    {
      var taxis =  await oneSupplierTaxis(arguments[0],arguments[1],arguments[2]);
      console.log(taxis);
    }
    else
    {
      var taxis = await allSuppliersTaxis(arguments[0],arguments[1],arguments[2]);
      console.log(taxis);
    }
    break;
  case 4:
    var taxis =  await oneSupplierTaxis(arguments[0],arguments[1],arguments[2],arguments[3]);
    console.log(taxis);
    break;
  default:
